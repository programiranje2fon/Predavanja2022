...
Napraviti javnu klasu **TestVozila** u paketu **dvocas8_sreda.zadatak1.test** u čijoj main metodi se pravi jedan objekat klase MotornoVozilo.**(nije moguće napraviti instancu tj. objekat apstraktne klase, poenta je u podklasama)**
...
Napraviti javnu klasu **UtopijskiMesovitiAutomat** u paketu **dvocas8_sreda.zadatak2** koja implementira oba interfejsa (AutomatZaKafu i AutomatZaCokoladice) i ima:**(implementacija interfejsa, implementacija više interfejsa)**
